#!/usr/bin/env python3
"""
Qa Persona Command - Cursor Wrapper
...
def main():
    ...
    subprocess.run([
        ...
        '--persona', 'qa',
        ' '.join(sys.argv[1:]) if sys.argv[1:] else 'Please provide the feature or code to be tested. I will design a comprehensive test plan and identify potential quality issues.'
    ], check=False)
