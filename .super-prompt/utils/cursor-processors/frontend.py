#!/usr/bin/env python3
"""
Frontend Persona Command - Cursor Wrapper
...
def main():
    ...
    subprocess.run([
        ...
        '--persona', 'frontend',
        ' '.join(sys.argv[1:]) if sys.argv[1:] else 'Please describe the frontend task. I can help with component development, UI/UX implementation, and state management.'
    ], check=False)
