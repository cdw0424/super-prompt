#!/usr/bin/env python3
"""
Refactorer Persona Command - Cursor Wrapper
...
def main():
    ...
    subprocess.run([
        ...
        '--persona', 'refactorer',
        ' '.join(sys.argv[1:]) if sys.argv[1:] else "Please provide the code you'd like to refactor. I will improve its structure, readability, and maintainability without changing its external behavior."
    ], check=False)
