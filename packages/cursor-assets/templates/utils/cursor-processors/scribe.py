#!/usr/bin/env python3
"""
Scribe Persona Command - Cursor Wrapper
...
def main():
    ...
    subprocess.run([
        ...
        '--persona', 'scribe',
        ' '.join(sys.argv[1:]) if sys.argv[1:] else 'Ready to document. What technical concepts, processes, or code would you like me to write about?'
    ], check=False)
