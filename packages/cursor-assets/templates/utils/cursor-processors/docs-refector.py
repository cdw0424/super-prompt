#!/usr/bin/env python3
"""
Docs Refector Persona Command - Cursor Wrapper
...
def main():
    ...
    subprocess.run([
        ...
        ' '.join(sys.argv[1:]) if sys.argv[1:] else 'Please provide the documentation that needs refactoring. I will improve its clarity, structure, and accuracy.'
    ], check=False)
