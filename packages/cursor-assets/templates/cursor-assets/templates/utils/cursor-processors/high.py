#!/usr/bin/env python3
"""
High Persona Command - Cursor Wrapper
...
def main():
    ...
    subprocess.run([
        ...
        '--persona', 'high',
        ' '.join(sys.argv[1:]) if sys.argv[1:] else 'Please provide the complex problem requiring deep strategic analysis. I will provide a thorough and insightful evaluation.'
    ], check=False)
