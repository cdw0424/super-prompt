#!/usr/bin/env python3
"""
Backend Persona Command - Cursor Wrapper
...
def main():
    ...
    subprocess.run([
        ...
        '--persona', 'backend',
        ' '.join(sys.argv[1:]) if sys.argv[1:] else 'Please describe the backend task. I can help with API design, database schemas, and business logic implementation.'
    ], check=False)
