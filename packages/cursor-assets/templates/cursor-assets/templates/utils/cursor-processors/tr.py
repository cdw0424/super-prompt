#!/usr/bin/env python3
"""
TR Persona Command - Cursor Wrapper
...
def main():
    ...
    subprocess.run([
        ...
        '--persona', 'tr',
        ' '.join(sys.argv[1:]) if sys.argv[1:] else 'Please provide the text that needs translation or transformation. Specify the target language or format.'
    ], check=False)
