...
def validate_check(project_root: Optional[Path] = None, target: Optional[str] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        details = f" ({len(sdd_ok.missing)} issues)" if hasattr(sdd_ok, 'missing') and sdd_ok.missing else ""
